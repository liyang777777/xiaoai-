  ...
  <div class="content">
    ...
    <div class="All">
      <el-form ref="form" :model="sizeForm" :rules="rules" label-width="100px" size="mini">
        ...
        <el-form-item label="文章摘要" prop="abstract" class="All1">
          <el-input v-model="sizeForm.name"></el-input>
        </el-form-item>
        <el-form-item label="作者" prop="author" class="All1">
          <el-input v-model="sizeForm.name"></el-input>
        </el-form-item>
        <el-form-item label="类目" prop="Class" class="All1">
        ...
        <el-form-item label="来源" prop="source" class="All1">
          <el-select v-model="sizeForm.region" placeholder="请选择">
        ...
        <el-form-item label="重要性" prop="importance" class="All1">
          <el-select v-model="sizeForm.region" placeholder="请选择">
