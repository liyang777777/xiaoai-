  ...
  <div class="content">
    ...
    <div class="All">
      <el-form ref="form" :model="sizeForm" :rules="rules" label-width="100px" size="mini">
        ...
        <el-form-item label="作者" prop="author" class="All3" width='50px'>
          <el-input v-model="sizeForm.name"></el-input>
        </el-form-item>
        <el-form-item label="类目" prop="Class" class="All4" width='100px'>
        ...
        <el-form-item label="来源" prop="source" class="All5" width='100px'>
          <el-select v-model="sizeForm.region" placeholder="请选择">
        ...
        <el-form-item label="重要性" prop="importance" class="All6" width='100px'>
          <el-select v-model="sizeForm.region" placeholder="请选择">
