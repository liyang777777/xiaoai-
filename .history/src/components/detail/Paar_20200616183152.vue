      ...
      <el-form ref="form" :model="sizeForm" :rules="rules" label-width="100px" size="mini">
        ...
        <el-form-item label="类目" prop="category" class="All4">
          <el-select v-model="sizeForm.category" placeholder="请选择">
            <el-option label="category1" value="vue"></el-option>
            <el-option label="category2" value="React"></el-option>
            <el-option label="category3" value="Node.js"></el-option>
            <el-option label="category4" value="性能优化"></el-option>
            <el-option label="category5" value="JavaScript"></el-option>
            <el-option label="category6" value="小程序"></el-option>
            <el-option label="category7" value="工具类"></el-option>
            <el-option label="category8" value="其他"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="来源" prop="source" class="All5">
          <el-select v-model="sizeForm.source" placeholder="请选择">
            <el-option label="source1" value="原创"></el-option>
            <el-option label="source2" value="转载"></el-option>
            <el-option label="source3" value="与他人合作"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="重要性" prop="star" class="All6">
          <el-select v-model="sizeForm.star" placeholder="请选择">
            <el-option label="star1" value="1"></el-option>
            <el-option label="star2" value="2"></el-option>
            <el-option label="star3" value="3"></el-option>
            <el-option label="star4" value="4"></el-option>
            <el-option label="star5" value="5"></el-option>
          </el-select>
        </el-form-item>
        <div class="bolck">
        ...
        <el-row>
          <el-button type="primary" class="box3" size="mini" @click="getParr">发布</el-button>
        </el-row>
      </el-form>
    </div>
  </div>
