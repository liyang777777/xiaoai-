    ...
    <div class="All">
      <el-form ref="form" :model="sizeForm" :rules="rules" label-width="100px" size="mini">
        ...
        <el-form-item label="类目" prop="category" class="All4">
          <el-select v-model="sizeForm.Class" placeholder="请选择">
        ...
        <el-form-item label="重要性" prop="star" class="All6">
          <el-select v-model="sizeForm.importance" placeholder="请选择">
    ...
    getParr() {
      axios
        .post("/api/article/create", {
          ...
          Class: this.sizeForm.Class,
          source: this.sizeForm.source,
          importance: this.sizeForm.importance,
          text: this.text,
          date: this.date
        })
        .then(res => {
